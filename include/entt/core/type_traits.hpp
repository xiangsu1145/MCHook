...
/**
 * @brief Applies the constness of one type to another.
 * @tparam From Type to which constness will be applied.
 * @tparam To Type whose constness will be used.
 */
template<typename From, typename To>
using constness_as_t = std::conditional_t<std::is_const_v<std::remove_reference_t<To>>, std::add_const_t<From>, From>;
