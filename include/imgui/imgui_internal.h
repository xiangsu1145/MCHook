...
struct IMGUI_API ImDrawListSharedData
{
    ...
    int*                         ShadowRectIds;   // IDs of rect for shadow textures
    const ImVec4*                      ShadowRectUvs;  // UV coordinates for shadow textures, 9 for the rectangle shadows and the final entry for the convex shape shadows
